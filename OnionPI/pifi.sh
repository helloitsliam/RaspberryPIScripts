...
echo -e "subnet 10.5.5.0 netmask 255.255.255.0 {
range 10.5.5.1 10.5.5.200;
option broadcast-address 10.5.5.255;
option routers 10.5.5.254;
default-lease-time 600;
max-lease-time 7200;
option domain-name \042helloitsliampi\042;
...
echo "$(tput setaf 6)Assigning static IP address 10.5.5.254..$(tput sgr0)"
ifconfig wlan0 10.5.5.254
